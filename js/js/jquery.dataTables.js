...
(function ($, window, document) {
    ...
    $.fn.dataTable = function (oInit)
    {
        ...
        function classSettings()
        {
             ...
             */
            this.oLanguage = {
                "sProcessing": "<label class='fuentes'>Cargando...</label>",
                "sLengthMenu": "<label class='fuentes'>Ver _MENU_ registros</label>",
                "sZeroRecords": "<label class='fuentes'>No se produjo ningún resultado</label>",
                "sEmptyTable": "<label class='fuentes'>No existen registros para mostrar</label>",
                "sInfo": "<label class='fuentes'>Resultado _START_ - _END_ de _TOTAL_ registros</label>",
                "sInfoEmpty": "<label class='fuentes'>Registros 0 - 0 de 0 Entradas</label>",
                "sInfoFiltered": "(Filtrado de _MAX_ registros)",
                "sInfoPostFix": "",
                "sSearch": "<label class='fuentes'>Buscar :</label>",
                "sUrl": "",
                "oPaginate": {
                    "sFirst": "<label class='fuentes'>Primero</label>",
                    "sPrevious": "<label class='fuentes'>Anterior</label>",
                    "sNext": "<label class='fuentes'>Siguiente</label>",
                    "sLast": "<label class='fuentes'>Ultimo</label>"
                },
                "fnInfoCallback": null
            };
        ...
        function _fnScrollDraw(o)
        {
            ...
            anHeadSizers = nSize.getElementsByTagName('tr');
        ...
        function _fnFeatureHtmlFilter(oSettings)
        {
            ...
            nFilter.innerHTML = oSettings.oLanguage.sSearch + sSpace + '<input class="bordes" type="text" />';
        ...
        function _fnFeatureHtmlLength(oSettings)
        {
            ...
            var sStdMenu = '<select class="bordes1" size="1" ' + sName + '>';
            var i, iLen;
